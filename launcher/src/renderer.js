...
const ICONS={cape_shadow:'🖤',cape_light:'🤍',cape_sun:'☀️',cape_rainbow:'🌈',cape_fire:'🔥',cape_ice:'❄️',cape_void:'🕳️',cape_emerald:'💎',cape_redstone:'🔴',cape_ender:'🟣',cape_nether:'🟠',cape_cherry:'🌸',cape_galaxy:'🌌',cape_phantom:'👻',cape_creeper:'💚',cape_wither:'💀',cape_drachen:'🐉',cape_fruehling:'🌷',cape_sommer:'🌻',cape_herbst:'🍂',cape_winter:'❄️',cape_einhorn:'🦄',cape_enderman:'🟪',cape_erde:'🌍',cape_zeus:'⚡',cape_kawaii:'💖',cape_neon:'💜',cape_vulkan:'🌋',cape_warden:'🔵',cape_odin:'🗡️',cape_anubis:'🐺',cape_pirat:'🏴‍☠️',cape_ostern:'🐣',cape_halloween:'🎃',hat_crown:'👑',hat_wizard:'🧙',hat_top:'🎩',hat_santa:'🎅',hat_viking:'⚔️',hat_pirate:'🏴‍☠️',hat_samurai:'🗡️',hat_astronaut:'🧑‍🚀',hat_knight:'🛡️',hat_beret:'🎨',hat_mushroom:'🍄',hat_halo:'😇',hat_devil:'😈',hat_creeper:'💚',hat_drachen:'🐲',hat_blumenkranz:'🌺',hat_schneekrone:'❄️',hat_sonnenkrone:'☀️',hat_schattenkrone:'🖤',hat_lichtkrone:'🤍',hat_wither:'💀',hat_enderdrache:'🐉',hat_phoenix:'🔥',hat_warden:'🔵',hat_chibi:'💖',hat_neon:'💜',wings_angel:'👼',wings_demon:'🦇',wings_dragon:'🐉',wings_butterfly:'🦋',wings_phoenix:'🔥',wings_bee:'🐝',wings_crystal:'💠',wings_bat:'🦇',wings_fairy:'🧚',wings_steampunk:'⚙️',wings_ender:'🟣',wings_wither:'💀',wings_eis:'❄️',wings_herbst:'🍂',wings_schatten:'🖤',wings_sonnen:'☀️',wings_einhorn:'🦄',wings_creeper:'💚',aura_flame:'🔥',aura_snow:'🌨️',aura_hearts:'💕',aura_music:'🎵',aura_enchant:'✨',aura_lightning:'⚡',aura_cherry:'🌸',aura_void:'🌑',aura_rainbow:'🌈',aura_bubbles:'🫧',aura_skulls:'💀',aura_diamond:'💎',aura_bats:'🦇',aura_wither:'💀',aura_creeper:'💚',aura_drache:'🐉',aura_fruehling:'🌷',aura_sommer:'🌻',aura_herbst:'🍂',aura_winter:'❄️',aura_einhorn:'🦄',aura_schatten:'🖤',aura_sonnen:'☀️',emote_dab:'🙆',emote_wave:'👋',emote_salute:'🫡',emote_breakdance:'🕺',emote_floss:'💃',emote_headbang:'🤘',emote_clap:'👏',emote_facepalm:'🤦',emote_freude:'🎉',emote_weinen:'😢',emote_lachen:'😂',emote_verbeugung:'🙇',emote_muskeln:'💪',emote_schlafen:'😴',emote_ninja:'🥷',emote_huehner:'🐔',emote_wut:'😡',emote_dj:'🎧',emote_schwert:'⚔️',emote_zaubern:'🪄',pet_cat:'🐱',pet_dog:'🐶',pet_parrot:'🦜',pet_fox:'🦊',pet_axolotl:'🐙',pet_bee:'🐝',pet_dragon:'🐲',pet_ghost:'👻',pet_creeper:'💚',pet_endermite:'🟣',pet_wolf:'🐺',pet_phoenix:'🔥',pet_einhorn:'🦄',pet_schneemann:'⛄',pet_fledermaus:'🦇',pet_schildkroete:'🐢',pet_wither:'💀',pet_allay:'💙',trail_fire:'🔥',trail_ice:'❄️',trail_rainbow:'🌈',trail_flowers:'🌺',trail_lightning:'⚡',trail_shadow:'🌑',trail_creeper:'💚',trail_ender:'🟣',trail_lava:'🌋',trail_noten:'🎵',trail_herzen:'💕',trail_sterne:'⭐',trail_pilze:'🍄',trail_wither:'💀',particle_feuer:'🔥',particle_wasser:'💧',particle_erde:'🌍',particle_luft:'💨',particle_endportal:'🟣',particle_totem:'✨',particle_seelen:'👻',particle_redstone:'🔴',particle_nether:'🟠',particle_kirschbluete:'🌸',particle_drache:'🐉',particle_schatten:'🖤',particle_sonnenstaub:'☀️',particle_lichtfunken:'⚡',particle_schneesturm:'❄️',particle_gluehwurm:'💡',acc_sonnenbrille:'🕶️',acc_monokel:'🧐',acc_schal_schatten:'🧣',acc_schal_licht:'🧣',acc_schal_sonne:'🧣',acc_schwert:'⚔️',acc_fluegel:'🪽',acc_umhang:'🔥',acc_kette:'💎',acc_ring:'💍',acc_guertel:'🔴',acc_schulterdrache:'🐉',acc_rucksack:'🎒',acc_banner:'🏳️',acc_laterne:'🏮',acc_zauberbuch:'📖',mask_fuchs:'🦊',mask_wolf:'🐺',mask_drache:'🐉',mask_oni:'👹',mask_phantom:'👻',mask_warden:'🔵',mask_anubis:'🐺',mask_creeper:'💚',mask_enderman:'🟪',mask_wither:'💀',mask_eisfuchs:'🦊',mask_phoenix:'🔥',mask_samurai:'⚔️',mask_chibi:'💖',mask_neon:'💜',mask_pirat:'🏴‍☠️',mask_halloween:'🎃',mount_pferd:'🐴',mount_drache:'🐉',mount_einhorn:'🦄',mount_wither:'💀',mount_phoenix:'🔥',mount_wolf:'🐺',mount_baer:'🐻',mount_spinne:'🕷️',mount_ender:'🟣',mount_magma:'🌋',mount_delphin:'🐬',mount_adler:'🦅',mount_panther:'🐆',mount_greif:'🦅',mount_schildkroete:'🐢',banner_schatten:'🖤',banner_licht:'🤍',banner_sonne:'☀️',banner_flamme:'🔥',banner_eis:'❄️',banner_neon:'💜',banner_pixel:'🎮',banner_regenbogen:'🌈',banner_drache:'🐉',banner_totenkopf:'💀',banner_blumen:'🌺',sound_donner:'⚡',sound_schwert:'⚔️',sound_magie:'✨',sound_8bit:'🎮',sound_natur:'🌿',sound_feuer:'🔥',sound_wasser:'💧',sound_kristall:'💎',sound_glocke:'🔔',sound_wind:'💨',title_ritter:'⚔️',title_koenig:'👑',title_meister:'🏆',title_schattenlord:'🖤',title_lichtwaechter:'🤍',title_sonnenkoenig:'☀️',title_drachenreiter:'🐉',title_hexenmeister:'🧙',title_pirat:'🏴‍☠️',title_jaeger:'🏹'};
...
function renderCosmetics() {
  ...
  g.innerHTML=cosmetics.filter(c=>c.category===currentCat).map(c=>{
    ...
    return '<div class="'+cls+'" onclick="cosClick(\''+c.id+'\')"><div class="cosm-icon" style="background:'+grad+'"><span class="cosm-icon-emoji">'+ico+'</span></div><div class="cosm-name">'+c.name+'</div><div class="cosm-desc">'+c.description+'</div><div class="cosm-foot"><span class="cosm-price">&#x1FA99; '+c.price+'</span>'+badge+'</div></div>';
  }).join('');
}
