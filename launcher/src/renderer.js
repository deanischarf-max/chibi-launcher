...
const CAT_SVGS={capes:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M20 12 L44 12 L48 52 L38 48 L32 56 L26 48 L16 52 Z" fill="white" opacity="0.9"/></svg>',hats:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M22 50 L42 50 L42 30 L48 30 L32 8 L16 30 L22 30 Z" fill="white" opacity="0.9"/></svg>',wings:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M32 32 L8 16 L4 8 L16 20 L24 12 L28 24 L32 20 L36 24 L40 12 L48 20 L60 8 L56 16 L32 32 L32 48 Z" fill="white" opacity="0.9"/></svg>',auras:'<svg width="60" height="60" viewBox="0 0 64 64"><circle cx="32" cy="32" r="20" fill="none" stroke="white" stroke-width="3" opacity="0.9"/><circle cx="32" cy="32" r="12" fill="none" stroke="white" stroke-width="2" opacity="0.5"/><circle cx="32" cy="32" r="4" fill="white" opacity="0.9"/></svg>',emotes:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M12 12 L52 12 L52 38 L28 38 L20 48 L22 38 L12 38 Z" fill="white" opacity="0.9" rx="4"/></svg>',pets:'<svg width="60" height="60" viewBox="0 0 64 64"><circle cx="32" cy="24" r="12" fill="white" opacity="0.9"/><circle cx="26" cy="20" r="3" fill="white" opacity="0.9"/><circle cx="38" cy="20" r="3" fill="white" opacity="0.9"/><ellipse cx="32" cy="44" rx="10" ry="12" fill="white" opacity="0.9"/><circle cx="28" cy="22" r="2" fill="black"/><circle cx="36" cy="22" r="2" fill="black"/></svg>',trails:'<svg width="60" height="60" viewBox="0 0 64 64"><circle cx="12" cy="48" r="3" fill="white" opacity="0.3"/><circle cx="20" cy="40" r="4" fill="white" opacity="0.5"/><circle cx="30" cy="32" r="5" fill="white" opacity="0.7"/><circle cx="42" cy="24" r="6" fill="white" opacity="0.85"/><circle cx="52" cy="16" r="7" fill="white" opacity="0.95"/></svg>',particles:'<svg width="60" height="60" viewBox="0 0 64 64"><polygon points="32,4 34,14 44,14 36,20 38,30 32,24 26,30 28,20 20,14 30,14" fill="white" opacity="0.9"/><polygon points="14,34 16,40 22,40 18,44 19,50 14,46 9,50 10,44 6,40 12,40" fill="white" opacity="0.6"/><polygon points="50,38 51,42 55,42 52,45 53,49 50,46 47,49 48,45 45,42 49,42" fill="white" opacity="0.7"/></svg>',accessories:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M16 16 Q32 32 48 16" fill="none" stroke="white" stroke-width="3" opacity="0.9"/><circle cx="32" cy="28" r="6" fill="white" opacity="0.9"/></svg>',masks:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M12 20 Q12 12 32 12 Q52 12 52 20 L52 32 Q52 44 32 44 Q12 44 12 32 Z" fill="white" opacity="0.9"/><ellipse cx="22" cy="26" rx="6" ry="5" fill="black"/><ellipse cx="42" cy="26" rx="6" ry="5" fill="black"/></svg>',mounts:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M18 48 L18 36 L14 24 L20 16 L28 12 L32 16 L28 24 L36 24 L44 16 L48 20 L44 28 L46 36 L46 48 L40 48 L40 40 L24 40 L24 48 Z" fill="white" opacity="0.9"/></svg>',banners:'<svg width="60" height="60" viewBox="0 0 64 64"><rect x="16" y="8" width="4" height="48" fill="white" opacity="0.9"/><path d="M20 8 L52 8 L46 20 L52 32 L20 32 Z" fill="white" opacity="0.9"/></svg>',sounds:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M24 20 L24 44 L20 44 Q12 44 12 36 Q12 28 20 28 L24 28" fill="white" opacity="0.9"/><path d="M24 20 L44 12 L44 40 L24 44" fill="none" stroke="white" stroke-width="3" opacity="0.7"/><circle cx="44" cy="40" r="6" fill="white" opacity="0.9"/></svg>',titles:'<svg width="60" height="60" viewBox="0 0 64 64"><path d="M12 40 L12 20 L22 28 L32 16 L42 28 L52 20 L52 40 Z" fill="white" opacity="0.9"/><rect x="12" y="40" width="40" height="6" fill="white" opacity="0.7"/></svg>'};
...
function renderCosmetics() {
  ...
  g.innerHTML=cosmetics.filter(c=>c.category===currentCat).map(c=>{
    ...
    return '<div class="'+cls+'" onclick="cosClick(\''+c.id+'\')"><div class="cosm-icon" style="background:'+grad+'">'+CAT_SVGS[c.category]+'</div><div class="cosm-name">'+c.name+'</div><div class="cosm-desc">'+c.description+'</div><div class="cosm-foot"><span class="cosm-price">&#x1FA99; '+c.price+'</span>'+badge+'</div></div>';
  }).join('');
}
